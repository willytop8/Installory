...
Cruft never removes anything directly. The cleanup script we generate (see `docs/safety.md`) emits the right command for each kind of interpreter; the user runs it in Terminal.
